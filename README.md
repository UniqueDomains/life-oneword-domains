# Available .LIFE One-Word Domains (9,483)
...
> The full live catalog for this exact search currently contains **9,483 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,483 domains · **Median ask:** $6.56 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,483 live domains                         |
...
> Unique Domains. *Available .LIFE One-Word Domains*. Version 2026-05-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
